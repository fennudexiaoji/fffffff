package com.common.lib.divider;
...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean isShowFootViewDivider=true;
    public void showLastFootViewDivider(boolean isShowFootViewDivider){//有上啦加载的时候使用
        this.isShowFootViewDivider=isShowFootViewDivider;
    }
    ...
    private void draw(Canvas canvas, RecyclerView parent) {
        int childSize;
        if(!isShowFootViewDivider){//1为footView个数
            childSize = parent.getChildCount()-1;
        }else {
