...
public abstract class BaseListPullRecyclerFragment<T extends BasePresenter> extends BaseFragment {
  ...
  protected void initPullRecycler(StatusViewLayout statusViewLayout,PullRecycler mPullRecycler,BaseRecyclerAdapter adapter) {
