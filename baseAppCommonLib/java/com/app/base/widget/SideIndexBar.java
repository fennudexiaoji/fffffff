...
public class SideIndexBar extends View{
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        mTextSize =typedArray.getDimensionPixelSize(R.styleable.SideIndexBar_cpIndexBarTextSize,12);//给他赋值一个红色
        mTextColor =typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarNormalTextColor,0xffff0000);//给他赋值一个红色
        mTextTouchedColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarSelectedTextColor,0x00000000);
        typedArray.recycle();
